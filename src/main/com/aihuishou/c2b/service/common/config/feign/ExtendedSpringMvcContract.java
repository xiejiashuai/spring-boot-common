...
import static com.aihuishou.c2b.service.common.config.feign.util.FeignUtils.addTemplateParameter;
import static feign.Util.checkState;
import static feign.Util.emptyToNull;
import static org.springframework.core.annotation.AnnotatedElementUtils.findMergedAnnotation;

/**
 * 扩展原生的SpringMvcContract
 *
 * @author jiashuai.xie
 * @since 2018/12/24 11:07
 */
public class ExtendedSpringMvcContract extends Contract.BaseContract implements ResourceLoaderAware {
    ...
    public ExtendedSpringMvcContract() {
